	...
	Describe("for more complex assertions", func() {
		...
		When("ns.nip.io is queried", func() {
			It("returns all the A records", func() {
				...
				Eventually(digSession, 1).Should(Exit(0))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeA ns.nip.io. \? 167.172.4.236, 104.155.144.4, 5.78.115.44, 51.75.53.19\n`))
			})
			It("returns all the AAAA records", func() {
				...
				Eventually(digSession, 1).Should(Exit(0))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeAAAA ns.nip.io. \? 2400:6180:0:d2:0:2:e3e7:0, 2600:1900:4000:4d12::, 2a01:4ff:1f0:c920::, 2001:41d0:602:2313::1\n`))
			})
		})
		When("ns.sslip.io is queried", func() {
			It("returns all the A records", func() {
				...
				Eventually(digSession).Should(Say(`51.75.53.19`))
				Eventually(digSession, 1).Should(Exit(0))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeA ns.sslip.io. \? 167.172.4.236, 104.155.144.4, 5.78.115.44, 51.75.53.19\n`))
			})
			It("returns all the AAAA records", func() {
				...
				Eventually(digSession).Should(Say(`2001:41d0:602:2313::1`))
				Eventually(digSession, 1).Should(Exit(0))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeAAAA ns.sslip.io. \? 2400:6180:0:d2:0:2:e3e7:0, 2600:1900:4000:4d12::, 2a01:4ff:1f0:c920::, 2001:41d0:602:2313::1\n`))
			})
		})
