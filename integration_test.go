	...
	Describe("Integration tests", func() {
		DescribeTable("when the DNS server is queried",
			...
			Entry("A (or lack thereof) for example.com",
				...
				`\A\z`,
				`TypeA example.com. \? nil, SOA example.com. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			...
			Entry("AAAA not found for example.com",
				...
				`\A\z`,
				`TypeAAAA example.com. \? nil, SOA example.com. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			Entry("AAAA for www-2601-645-8103-e3a0-1c09-bae7-aa42-146c.sslip.io",
				"@localhost www-2601-645-8103-e3a0-1c09-bae7-aa42-146c.sslip.io aaaa +short",
				`\A2601:645:8103:e3a0:1c09:bae7:aa42:146c\n\z`,
				`TypeAAAA www-2601-645-8103-e3a0-1c09-bae7-aa42-146c.sslip.io. \? 2601:645:8103:e3a0:1c09:bae7:aa42:146c\n`),
			...
			Entry("CNAME not found for example.com",
				...
				`\A\z`,
				`TypeCNAME example.com. \? nil, SOA example.com. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			...
			Entry("SOA for sslip.io",
				...
				`\Asslip.io. briancunnie.gmail.com. 20260704 900 900 1800 180\n\z`,
				`TypeSOA sslip.io. \? sslip.io. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			Entry("SOA for example.com",
				"@localhost example.com soa +short",
				`\Aexample.com. briancunnie.gmail.com. 20260704 900 900 1800 180\n\z`,
				`TypeSOA example.com. \? example.com. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			Entry("SRV (or other record that we don't implement) for example.com",
				"@localhost example.com srv +short",
				`\A\z`,
				`TypeSRV example.com. \? nil, SOA example.com. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			...
			Entry(`TXT is the querier's IPv4 address and the domain is NOT "ip.sslip.io"`,
				...
				`\A\z`,
				`TypeTXT example.com. \? nil, SOA example.com. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			...
			Entry(`get a PTR for 1.0.0.127.blah.in-addr.arpa returns no records; "blah.in-addr.arpa is not a valid domain."`,
				...
				`\A\z`,
				`TypePTR 1.0.0.127.blah.in-addr.arpa. \? nil, SOA sslip.io. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			Entry(`get a PTR for blah.1.0.0.127.in-addr.arpa returns no records; "blah" isn't a valid subdomain' `,
				...
				`\A\z`,
				`TypePTR blah.1.0.0.127.in-addr.arpa. \? nil, SOA sslip.io. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			Entry(`get a PTR for 0.0.127.in-addr.arpa returns no records; should have 4 octets, not 3`,
				...
				`\A\z`,
				`TypePTR 0.0.127.in-addr.arpa. \? nil, SOA sslip.io. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			Entry(`get a PTR for 2.a.b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.ip6.arpa returns 2601-645-8103-e3a0-14ce-6eea-9204-bba2.nip.io`,
				"@127.0.0.1 ptr -x 2601:645:8103:e3a0:14ce:6eea:9204:bba2 +short",
				`\A2601-645-8103-e3a0-14ce-6eea-9204-bba2.nip.io.\n\z`,
				`TypePTR 2.a.b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.ip6.arpa. \? 2601-645-8103-e3a0-14ce-6eea-9204-bba2.nip.io.`),
			Entry(`get a PTR for 2.a.b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.blah.ip6.arpa returns no records; "blah isn't a valid subdomain'"`,
				"@127.0.0.1 2.a.b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.blah.ip6.arpa ptr +short",
				`\A\z`,
				`TypePTR 2.a.b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.blah.ip6.arpa. \? nil, SOA sslip.io. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			Entry(`get a PTR for b2.a.b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.ip6.arpa returns no records; "b2" isn't a valid subdomain'`,
				"@127.0.0.1 b2.a.b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.ip6.arpa ptr +short",
				`\A\z`,
				`TypePTR b2.a.b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.ip6.arpa. \? nil, SOA sslip.io. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
			Entry(`get a PTR for b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.ip6.arpa returns no records; has too few numbers`,
				"@127.0.0.1 b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.ip6.arpa ptr +short",
				`\A\z`,
				`TypePTR b.b.4.0.2.9.a.e.e.6.e.c.4.1.0.a.3.e.3.0.1.8.5.4.6.0.1.0.6.2.ip6.arpa. \? nil, SOA sslip.io. briancunnie.gmail.com. 20260704 900 900 1800 180\n`),
	...
	Describe("for more complex assertions", func() {
		...
		When("ns.nip.io is queried", func() {
			It("returns all the A records", func() {
				...
				digSession, err = Start(digCmd, GinkgoWriter, GinkgoWriter)
				Expect(err).ToNot(HaveOccurred())
				Eventually(digSession).Should(Say(`167.172.4.236`))
				Eventually(digSession).Should(Say(`5.78.28.211`))
				Eventually(digSession).Should(Say(`51.75.53.19`))
				Eventually(digSession, 1).Should(Exit(0))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeA ns.nip.io. \? 167.172.4.236, 5.78.28.211, 51.75.53.19\n`))
			})
			It("returns all the AAAA records", func() {
				...
				digSession, err = Start(digCmd, GinkgoWriter, GinkgoWriter)
				Expect(err).ToNot(HaveOccurred())
				Eventually(digSession).Should(Say(`2400:6180:0:d2:0:2:e3e7:0`))
				Eventually(digSession).Should(Say(`2a01:4ff:1f2:10d::`))
				Eventually(digSession).Should(Say(`2001:41d0:602:2313::1`))
				Eventually(digSession, 1).Should(Exit(0))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeAAAA ns.nip.io. \? 2400:6180:0:d2:0:2:e3e7:0, 2a01:4ff:1f2:10d::, 2001:41d0:602:2313::1\n`))
			})
		})
		When("ns.sslip.io is queried", func() {
			It("returns all the A records", func() {
				...
				Eventually(digSession).Should(Say(`51.75.53.19`))
				Eventually(digSession, 1).Should(Exit(0))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeA ns.sslip.io. \? 167.172.4.236, 5.78.28.211, 51.75.53.19\n`))
			})
			It("returns all the AAAA records", func() {
				...
				Eventually(digSession).Should(Say(`2001:41d0:602:2313::1`))
				Eventually(digSession, 1).Should(Exit(0))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeAAAA ns.sslip.io. \? 2400:6180:0:d2:0:2:e3e7:0, 2a01:4ff:1f2:10d::, 2001:41d0:602:2313::1\n`))
			})
		})
		...
		When("there are multiple NS records returned (e.g. almost any NS query)", func() {
			It("returns all the records", func() {
				...
				Eventually(digSession).Should(Say(`ns-00.nip.io..*167.172.4.236\n`))
				Eventually(digSession).Should(Say(`ns-00.nip.io..*2400:6180:0:d2:0:2:e3e7:0\n`))
				Eventually(digSession).Should(Say(`ns-01.nip.io..*5.78.28.211\n`))
				Eventually(digSession).Should(Say(`ns-01.nip.io..*2a01:4ff:1f2:10d::\n`))
				...
				Eventually(string(digSession.Out.Contents())).Should(MatchRegexp(`NS\tns-00.nip.io.\n`))
				Eventually(string(digSession.Out.Contents())).Should(MatchRegexp(`NS\tns-01.nip.io.\n`))
				Eventually(string(digSession.Out.Contents())).Should(MatchRegexp(`NS\tns-ovh.sslip.io.\n`))
				Eventually(string(serverSession.Err.Contents())).Should(MatchRegexp(`TypeNS example.com. \? ns-00.nip.io., ns-01.nip.io., ns-ovh.sslip.io.\n`))
			})
		})
	...
	Describe(`The domain blocklist`, func() {
		DescribeTable("when queried",
			...
			Entry("an A record with a forbidden string on the left-hand side is redirected",
				...
				`\A64.176.22.9\n\z`,
				`TypeA raiffeisen.94.228.116.140.sslip.io. \? 64.176.22.9\n$`),
			Entry("an A record with a forbidden string on the right-hand side is redirected",
				...
				`\A64.176.22.9\n\z`,
				`TypeA www.94-228-116-140.raiffeisen.com. \? 64.176.22.9\n$`),
			Entry("an A record with a forbidden string embedded is redirected",
				...
				`\A64.176.22.9\n\z`,
				`TypeA international-raiffeisen-bank.94.228.116.140.sslip.io. \? 64.176.22.9\n$`),
			...
			Entry("an AAAA record with a forbidden string is redirected",
				...
				`\A2001:19f0:c800:2315::\n\z`,
				`TypeAAAA international-raiffeisen-bank.2600--.sslip.io. \? 2001:19f0:c800:2315::\n$`),
			...
			Entry("an NS record with acme_challenge with a forbidden string is not delegated",
				...
				`\Ans-([a-z-]+\.sslip\.io|\d\d\.nip\.io)\.\nns-([a-z-]+\.sslip\.io|\d\d\.nip\.io)\.\nns-([a-z-]+\.sslip\.io|\d\d\.nip\.io)\.\n\z`,
				`TypeNS _acme-challenge.raiffeisen.fe80--.sslip.io. \? ns-00.nip.io., ns-01.nip.io., ns-ovh.sslip.io.\n$`),
			Entry("an A record with a forbidden CIDR is redirected",
				"@localhost nf.12.34.56.0.sslip.io +short",
				`\A64.176.22.9\n\z`,
				`TypeA nf.12.34.56.0.sslip.io. \? 64.176.22.9\n$`),
			Entry("an A record with a forbidden IP is redirected",
				"@localhost nf.23.45.67.89.sslip.io +short",
				`\A64.176.22.9\n\z`,
				`TypeA nf.23.45.67.89.sslip.io. \? 64.176.22.9\n$`),
			...
			Entry("an AAAA record with a forbidden CIDR is redirected",
				...
				`\A2001:19f0:c800:2315::\n\z`,
				`TypeAAAA 1234--1.sslip.io. \? 2001:19f0:c800:2315::\n$`),
		)
	})
