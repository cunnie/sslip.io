	...
	Describe("Integration tests", func() {
		DescribeTable("when the DNS server is queried",
			...
			Entry("A (or lack thereof) for example.com",
				...
				`\A\z`,
				`TypeA example.com. \? nil, SOA example.com. briancunnie.gmail.com. 2021061900 900 900 1800 300\n$`),
			...
			Entry("AAAA not found for example.com",
				...
				`\A\z`,
				`TypeAAAA example.com. \? nil, SOA example.com. briancunnie.gmail.com. 2021061900 900 900 1800 300\n$`),
			...
			Entry("CNAME not found for example.com",
				...
				`\A\z`,
				`TypeCNAME example.com. \? nil, SOA example.com. briancunnie.gmail.com. 2021061900 900 900 1800 300\n$`),
			...
			Entry("SOA for sslip.io",
				...
				`\Asslip.io. briancunnie.gmail.com. 2021061900 900 900 1800 300\n\z`,
				`TypeSOA sslip.io. \? sslip.io. briancunnie.gmail.com. 2021061900 900 900 1800 300\n$`),
			Entry("SOA for example.com",
				"@localhost example.com soa +short",
				`\Aexample.com. briancunnie.gmail.com. 2021061900 900 900 1800 300\n\z`,
				`TypeSOA example.com. \? example.com. briancunnie.gmail.com. 2021061900 900 900 1800 300\n$`),
			...
			Entry("TXT is the querier's IPv4 address when there are no custom/acme records",
